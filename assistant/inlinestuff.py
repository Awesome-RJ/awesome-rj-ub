...
ultpic = "https://telegra.ph/file/47a271c7b21b0d9baf9ed.png"
...
async def repo(e):
    res = [
        await e.builder.article(
            title="Awesome RJ Userbot",
            description="Userbot | Telethon",
            thumb=wb(ultpic, 0, "image/jpeg", []),
            text="• **Awesome RJ USERBOT** •",
            buttons=[
                [
                    Button.url("Repo", url="https://github.com/TeamAwesome RJ/Awesome RJ"),
                    Button.url(
                        "Addons", url="https://github.com/TeamAwesome RJ/Awesome RJAddons"
                    ),
                ],
                [Button.url("Support", url="t.me/Awesome RJSupport")],
            ],
        ),
    ]
    await e.answer(res, switch_pm="Awesome RJ Repo.", switch_pm_param="start")
